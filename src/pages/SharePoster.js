  ...
  const generatePoster = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        // Now place the user's image to the left of Bumrah
        if (userImg.complete && userImg.naturalHeight !== 0) {
          try {
            // Calculate size and position for user's image
            // Position user image on the left side of Bumrah
            ...
            console.log('User image placed successfully');
